				...
				<div class="card mb-3">
					...
					<div class="card-body">
                        ...
                        <div class="form-group">
								...
								<input class="form-control <?php echo form_error('Karyawan_id') ? 'is-invalid':'' ?>"
								 type="text" name="id" placeholder="Karyawan ID" />
                        ...
                        <div class="form-group">
								...
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="name" placeholder="Karyawan name" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
								 type="text" name="address" min="0" placeholder=" Karyawan Address" />
								<div class="invalid-feedback">
                          ...
                          <div class="form-group">
								...
								<input class="form-control <?php echo form_error('phone') ? 'is-invalid':'' ?>"
								 type="text" name="phone" min="0" placeholder="Karyawan Phone" />
								<div class="invalid-feedback">
