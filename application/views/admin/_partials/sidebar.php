...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'karyawan' ? 'active': '' ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('admin/karyawan/new_form') ?>">New Karyawan</a>
    ...
    <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'supplier' ? 'active': '' ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('admin/supplier/new_form') ?>">New Supplier</a>
